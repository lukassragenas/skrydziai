...
@section('content')
    <div class="container-fluid mt-5">
        ...
        <ul class="nav nav-tabs bg-light" id="myTab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="ticket-tab" href="{{ route('reserved') }}">Mano rezervuoti bilietai</a>
            </li>
            <li class="nav-item">
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form role="form" action="{{ route('stripe.post') }}" method="post"
                                                class="require-validation{{ $ticket->id }}" data-cc-on-file="false"
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class='form-row row'>
                                                        ...
                                                        <div class='col-xs-12 col-md-4 form-group expiration required'>
                                                            <label class='control-label'>Expiration
                                                                Year</label>
                                                            <input class='form-control card-expiry-year{{ $ticket->id }}'
